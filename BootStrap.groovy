...
class BootStrap {
    ...
    def init = { servletContext ->
       ...
       /* servletContext ->
        ...
        employee.firstname='akhil'
        employee.lastname='rawat'
       // employee.setAge(24)
        employee.save(flush:true)

            Employee employee1 = new Employee()

            employee1.firstname='Karan'
            employee1.lastname='kalra'
            // employee.setAge(24)
            employee1.save(flush:true)

            Employee employee2 = new Employee()

            employee2.firstname='Gunjan'
            employee2.lastname='mishra'
            // employee.setAge(26)
